...
class App:
    def __init__(self, master):
        ...
        self.chart_type = ttk.Combobox(master, values=["Bar Chart", "Pie Chart"], font=('Arial', 12))
        ...
        ttk.Label(master, text="Number of bars/slices:", font=('Arial', 14)).grid(row=1, column=0, padx=10, pady=10)
